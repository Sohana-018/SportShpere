...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            ...
            <div className="hidden lg:block relative h-[500px] w-full animate-in fade-in zoom-in-95 duration-1000 delay-300">
              <div className="absolute right-0 top-0 w-2/3 h-4/5 rounded-3xl overflow-hidden shadow-2xl shadow-primary/20 border border-white/10 rotate-3 hover:rotate-0 transition-transform duration-500">
                <img src="/hero/basketball.jpg" alt="Basketball Game" className="object-cover w-full h-full" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              </div>
              <div className="absolute left-0 bottom-0 w-3/5 h-2/3 rounded-3xl overflow-hidden shadow-2xl border border-white/10 -rotate-6 hover:-rotate-0 transition-transform duration-500 z-10">
      ...
      {/* Features Section */}
      <section className="py-20 bg-muted/30 border-y border-white/5 relative overflow-hidden">
        <div className="absolute inset-0 bg-grid-white/[0.02] bg-[size:32px_32px]" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="flex flex-col items-center text-center p-6 rounded-2xl bg-background/50 backdrop-blur-sm border border-white/5 hover:border-primary/30 transition-colors">
      ...
      <section className="py-24 container mx-auto px-4">
        ...
        {events && events.length > 0 ? (
          ...
          <div className="text-center py-20 bg-muted/30 rounded-2xl border border-white/5 border-dashed">
